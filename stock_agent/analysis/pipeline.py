...
def analyze_collection(result: Any) -> AnalysisResult:
    ...
    return analyze_market_events(
        ...
        macro_count=len(field_value(result, "macro_data", default=[]) or []),
        ...
        industry_count=len(field_value(result, "industry_data", default=[]) or []),
...
def analyze_market_events(
    *,
    ...
    driver_scores = build_driver_scores(event_signals, market_state)
